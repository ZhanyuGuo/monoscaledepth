...
def main():
    ...
    for file_name in file_names:
        if file_name.split(".")[1][0] == "j":
            image_names.append(file_name)
    
    num_image = len(image_names)
    print("num of images: ", num_image)    
    ...
    for i in range(num_image - 1):
        ...
        source_image_path = os.path.join(args.input_folder, image_names[i])
        target_image_path = os.path.join(args.input_folder, image_names[i + 1])
